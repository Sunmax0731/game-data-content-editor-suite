...
- 作業ディレクトリ: `D:\AI\UnityEditor\game-data-content-editor-suite`
...
```powershell
cd D:\AI\UnityEditor\game-data-content-editor-suite
npm test
npm start
```
...
5. Unity EditorWindow + validation core の UI または配布面を開き、検証結果をユーザーが次アクションに移せる粒度で確認する。
...
- docs ZIP が `dist/game-data-content-editor-suite-docs.zip` に存在する。
